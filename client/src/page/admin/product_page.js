        ...
        <form onSubmit={  (e) =>  add_product(e)}>
          <div className='list_item'>
            <div className='item_form'>
              ...
              <input type="text" className='name' placeholder='Tên sản phẩm'></input>
            </div>
            <div className='item_form'>
            ...
            <div className='item_form'>
              <p>Địa chỉ: <i>*</i></p>
              <input className='address' type="text" placeholder='Địa chỉ'></input>
            </div>
            <div className='item_form'>
              <p>Màu sắc: <i>*</i></p>
              <input className='color' type="text" placeholder='Màu sắc sản phẩm'></input>
            </div>
            <div className='item_form'>
              <p>Mô tả: <i>*</i></p>
              <textarea className='description' rows='3' placeholder="Thông tin mô tả"></textarea>
            </div>
            <div className='item_form'>
              <p>Mô tả chi tiết: <i>*</i></p>
              <textarea className='detail' rows='3' placeholder="Thông tin chi tiết"></textarea>
            </div>
            <div className='item_form'>
              <p>Hình ảnh: <i>*</i></p>
